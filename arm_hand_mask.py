...
def draw_hand(image, maskImage, landmark_list, connections, arm=False):
    ...
    PX = []  # Draws the connections if the start and end landmarks are both visible.
...
if __name__ == '__main__':
    ...
    if class_img == 1:
        ...
        save_pathcrop = r'/home/roblab20/PycharmProjects/PointClassification/eran_seg/data/10_01/Point'
        name = 'Point'
    else:
        save_path = r'/home/roblab20/PycharmProjects/PointClassification/eran_seg/data/image_mask_dataset_22_01/image'
    ...
    with mp_hands.Hands(
      ...
      for i in tqdm(range(data_points_to_record)):
        ...
        # cv2.putText(image, str(fps), (50, 50))
